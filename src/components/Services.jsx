...
export default function Services() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `
          linear-gradient(180deg, rgba(37, 99, 235, 0.05) 0%, rgba(248, 250, 252, 0.98) 50%, rgba(255, 255, 255, 1) 100%),
        ...
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className="group bg-white rounded-xl border border-gray-200/80 shadow-sm hover:shadow-xl hover:border-primary/30 transition-all duration-300 overflow-hidden"
            >
              <div className="p-7 flex flex-col h-full">
                {/* Icon container */}
                <div className="w-12 h-12 rounded-lg bg-primary/[0.07] text-primary flex items-center justify-center mb-5 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
                  {service.icon}
                </div>
